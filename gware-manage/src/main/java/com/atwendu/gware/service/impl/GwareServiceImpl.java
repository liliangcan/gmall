package com.atwendu.gware.service.impl;


import com.alibaba.fastjson.JSON;

import com.atwendu.gware.util.HttpclientUtil;
...
import com.atwendu.gware.bean.WareOrderTaskDetail;
import com.atwendu.gware.bean.WareSku;
import com.atwendu.gware.enums.TaskStatus;
import com.atwendu.gware.mapper.WareInfoMapper;
...
public class GwareServiceImpl implements GwareService {
    ...
    public   Map<String,List<String>>  getWareSkuMap(List<String> skuIdlist){
        ...
        for (WareSku wareSku : wareSkuList) {
            ...
            //仓库Id，商品Id [{"wareId":"1","skuIds":["2","10"]},{"wareId":"2","skuIds":["3"]}]
