package com.atwendu.gmall.list.controller;
...
//        System.out.println(skuLsResult.getTotalPages());      //排查成功，之前ListServiceImpl中使用setTotalPages方法时写错成setTotal方法
