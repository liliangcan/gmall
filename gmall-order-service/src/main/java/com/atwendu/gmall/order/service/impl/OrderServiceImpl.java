package com.atwendu.gmall.order.service.impl;

import com.alibaba.dubbo.config.annotation.Service;
import com.alibaba.fastjson.JSON;
import com.atwendu.gmall.bean.OrderDetail;
import com.atwendu.gmall.bean.OrderInfo;
import com.atwendu.gmall.bean.enums.OrderStatus;
...
import com.atwendu.gmall.order.mapper.OrderDetailMapper;
import com.atwendu.gmall.order.mapper.OrderInfoMapper;
...
public class OrderServiceImpl implements OrderService {
    ...
    public boolean checkStock(String skuId, Integer skuNum) {
        //调用gware-manage 库存系统 http://www.gware.com/hasStock
