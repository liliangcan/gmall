package com.atwendu.gmall.payment.controller;
...
import com.atwendu.gmall.payment.config.AlipayConfig;
...
//    @Autowired
    ...
    public String alipaySubmit(HttpServletRequest request, HttpServletResponse response) {
        /*
            1.保存支付记录，将数据放入数据库
              去重，对账! 幂等性=保证每一笔交易只能交易一次（第三方交易编号outTradeNo）
              paymentInfo
            2.生成二维码
         */
        //获取orderId
...
//        Map<String, String> paramsMap = ... //将异步通知中收到的所有参数都存放到map中
    ...
    //http://payment.gmall.com/sendPaymentResult?orderId=?&result=success
